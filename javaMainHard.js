...
circleEl.forEach(circleE => {
    circleE.addEventListener('click',(e)=>{
      ...
      if (circlechids < 10) {
        ...
        if (e.target.classList.contains("circle1")){
         ...
         alert("You have to choose 10 colors")
      }
       })
});
 ...
 let randomColor9=Math.floor(Math.random()*6);
 let randomColor10=Math.floor(Math.random()*6);
 let randomColors = [arr[randomColor1], arr[randomColor2], arr[randomColor3], arr[randomColor4], arr[randomColor5], arr[randomColor6], arr[randomColor7], arr[randomColor8], arr[randomColor9], arr[randomColor10]];
